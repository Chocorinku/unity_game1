...
public class Boss1Controller : MonoBehaviour
{
    ...
    public float moveStateChangeInterval = 4.0f;
    ...
    private void Attack1()
    {
        ...
        int attackCount = Random.Range(2, 9);
    ...
    {
        GameObject[] attackObjects = { attackKori1, attackKori2, attackKori3 };
